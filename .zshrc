...
# Add homebrow to PATH for macos
if [[ -f "/opt/homebrew/bin/brew" ]] then
  eval "$(/opt/homebrew/bin/brew shellenv)"
fi

# macOS: Activates mise for the current zsh session by executing its generated shell configuration.
if [[ "$(uname)" == "Darwin" && -x "$HOME/.local/bin/mise" ]]; then
...
alias ch='chezmoi'
alias cav='chezmoi apply -v' # apply all changes verbose
alias ca='chezmoi add'
alias ce='chezmoi edit'
alias cdf='chezmoi diff'
alias ci='chezmoi init git@github.com:KnJakob/dotfiles.git'
alias cia='chezmoi init --apply git@github.com:KnJakob/dotfiles.git'
